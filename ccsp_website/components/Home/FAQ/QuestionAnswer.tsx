...
const QuestionAnswer = () => {
  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-center mb-20">
        ...
        >
          ...
          <p className="subtext text-gray-300/90 leading-relaxed max-w-xl">
            {t("subtitle")}
            <span className="text-blue-400"> {t("help")}</span>
          </p>
        </div>
      </header>
      ...
      >
        <Card
          className=" container max-w-6xl text-center bg-[#0f142ed9] border border-gray-700/50 text-white px-8 py-20 md:py-18"
          role="region"
          aria-labelledby="faq-contact-title"
        >
